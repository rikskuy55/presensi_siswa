...
@section('title', 'Absensi Harian - Masuk')
                ...
                @if ($jadwal)
                    <div class="alert alert-warning">
                        ...
                        <span style="color: black; font-size: 16px;">
                            Jam masuk: <strong>{{ $jadwal->jam_masuk }}</strong><br> 
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <button id="takeabsen" class="btn btn-primary btn-block d-flex justify-content-center align-items-center py-2" style="border-radius: 50px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <span class="ml-2" style="font-size: 18px;">Absen Masuk</span>
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById("takeabsen").addEventListener("click", function() {
            Webcam.snap(function(data_uri) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('siswa.submit-absensi-harian') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        image: image,
                        lokasi: lokasi.value,
