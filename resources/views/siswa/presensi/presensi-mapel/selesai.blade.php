...
@section('title', 'Absensi Mata Pelajaran - Selesai')
            ...
            <div class="col text-center">
                ...
                <div class="alert alert-warning">
                    ...
                    <span style="color: black; font-size: 16px;">
                        Jam mulai: <strong>{{ $jadwal->jam_selesai }}</strong><br>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <button id="takekeluar"
                    ...
                    <span class="ml-2" style="font-size: 18px;">Absen Selesai</span>
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById("takekeluar").addEventListener("click", function() {
            Webcam.snap(function(data_uri) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('siswa.submit-absensi-selesai') }}", // Update dengan route yang sesuai untuk absensi mata pelajaran
                    data: {
                        _token: "{{ csrf_token() }}",
                        image: image,
                        lokasi: lokasi.value,
